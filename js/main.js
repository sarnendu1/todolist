...
function showtask(){
    ...
    taskObj.forEach((item, index) => {
        ...
        html += `<tr>
                    ...
                    ${taskCompleteValue}
                    <td><button class="button" type="button" onclick="edittask(${index})" class="text-primary"><span style="font-size: 1.5em; color: green;">
                    <i class="fas fa-edit"></i></span></button></td>
                    
                    <td><button type="button" class="button" onclick="deleteitem(${index})" class="text-danger"><span style="font-size: 1.5em; color: red;">
